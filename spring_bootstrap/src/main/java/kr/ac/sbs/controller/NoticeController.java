...
public class NoticeController {
	...
	@GetMapping("/detail")
	public ModelAndView detail(int nno,@RequestParam(defaultValue="")String from,ModelAndView mnv) throws Exception{
